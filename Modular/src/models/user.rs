...
impl User {
    ...
    pub fn to_html_string(&self) -> String {
        format!(
            r#"
                <div>
                    <span class="label">UUID: {uuid}</span>
                </div>
                <div>
                ...
                <div>
                    <span class="label">Created at: {created_at}</span>
                </div>
                <div>
                    <span class="label">Updated at: {updated_at}</span>
                </div>
            "#,
            uuid = self.uuid,
    ...
    ) -> Result<(Vec<Self>, Option<Pagination>), Box<dyn Errorr>>
    {
